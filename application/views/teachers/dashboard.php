      ...
      <div class="box">
        ...
        <div class="box-body">
           <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                  if(isset($teacher_details) && count($teacher_details)>0)
                  {
                    $i = 1;
                ...
                <tr>
                  <td><?php echo $i?></td>
                  <td><?php echo $ivalue['teacher_name']?></td>
                  <td><?php echo $ivalue['email_id']?></td>
                  <td><?php echo $ivalue['contact_no']?></td>
                  <td><?php echo $ivalue['address']?></td>
                  <td><?php echo $ivalue['sex']?></td>
                  <td><?php echo $ivalue['age']?></td>
                  <td><?php echo $ivalue['education']?></td>
                  <td><?php echo $ivalue['subject']?></td>
                  <td><?php echo $ivalue['experience']?></td>
                  <td><?php echo $ivalue['enrolled_on']?></td>
                  <td><a href="<?php echo base_url('TeachersCon/edit_teacher/'.$ivalue['teacher_id']);?>"><i class="fa fa-edit"></i></a>  <a href="<?php echo base_url('TeachersCon/del_teacher/'.$ivalue['teacher_id']);?>" onClick="DelConfirm()"><i class="fa fa-remove pull-right"></i></a></td>
                </tr>
                <?php
                    $i+=1;
                  }
                ...
                ?>
                <tr>
                  <td colspan="12" align="center"><p>No School admin found..!!</p></td>
                </tr>
              <?php } ?>
                </tbody>
                <tfoot>
